    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
        <li>
          <a
            href="#"
            class="flex items-center p-2 text-[#34E5F9] rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
          >
            <svg
              width="30px"
              height="30px"
        ...
        <li>
          ...
          >
            ...
            <span class="flex-1 ml-3 whitespace-nowrap text-[#464A50]">Team</span>
          </a>
        </li>
        <div style="margin-top: 300px" class="mt-[350px]">
          <li>
            <a
              href="#"
              class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
            >
              ...
              <span class="flex-1 ml-3 whitespace-nowrap text-[#464A50]">Support</span>
            </a>
          </li>
          <li>
            <a
            ...
            >
              ...
              <span class="flex-1 ml-3 whitespace-nowrap text-[#464A50]">Settings</span>
            </a>
          </li>
        </div>
      </ul>
      <div class="bg-[#F3F4F8] rounded-[5px] mt-[25px] pl-[10px]">
        <div class="text-[#464A50] text-[14px] font-bold pt-[20px] pb-[8px]">
          Need more than one workbook?
        </div>
        <div class="text-[#6A6E76] text-[14px]">
          Upgrade your plan for a slow as $59.99/m and create unlimited workbooks
        </div>
        <div class="flex justify-between pt-[15px] pb-[20px]">
          <div class="text-[#464A50] text-[14px] font-extrabold">Remind me later</div>
          <div class="text-[#34E5F9] text-[14px] mr-[10px]">Upgrade now</div>
        </div>
      </div>
      <hr class="mt-[20px]" />

      <div class="flex items-center space-x-4 mt-[20px]">
        ...
        <div class="font-medium dark:text-white">
          <div class="text-[#464A50] text-[14px] font-extrabold">Jonathan Smith</div>
          <div class="text-sm text-gray-500 dark:text-gray-400">js27@jusacut.com</div>
        </div>
      </div>
    </div>
  </aside>
